...
int main()
{
    ...
    std::string dataFilePath = "../../Data/TetMesh/mesh_files/initial_final_points.txt";
    ...
    std::vector<std::vector<double>> rescaledData = rescaleAndTranslateData(data, scaleFactors);
...
// Using the readF module
    ...
    std::string final_filename = "output/RIG_fleece_fibres/data_" + std::to_string(num_files) + ".dat";
