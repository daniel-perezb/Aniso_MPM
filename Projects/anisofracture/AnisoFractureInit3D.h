...
namespace Python {
extern double ax, ay, az, bx, by, bz, alpha1, alpha2, fiberScale, residual,
    percent, eta, E, rho, tau;
extern bool useRadial, useLongitudinal, isotropic, orthotropic, inextensible,
    implicit;
} // namespace Python
...
public:
  ...
  AnisoFractureInit3D(AnisoFractureSimulation<T, dim> &sim,
