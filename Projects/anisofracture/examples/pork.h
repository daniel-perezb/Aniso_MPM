...
std::string filename = "TetMesh/porkBelly500k.mesh"; // 50k is plenty for nice
...
if (Python::isotropic) {
  std::string path("output/3D_Pork/3D_Pork_Isotropic_Youngs" + E_str +
                   "_percent" + percent_str + "_eta" + eta_str + "_dx" +
                   dx_str + "_fiberScale" + scale_str);
  sim.output_dir.path = path;
} else if (orthotropic) {
  std::string path("output/3D_Pork/3D_Pork_Orthotropic_Youngs" + E_str +
                   "_percent" + percent_str + "_eta" + eta_str + "_dx" +
                   dx_str + "_fiberScale" + scale_str);
  sim.output_dir.path = path;
  ...
  std::string path("output/3D_Pork/3D_Pork_TransverseIsotropic_Youngs" + E_str +
                   "_percent" + percent_str + "_eta" + eta_str + "_dx" +
                   dx_str + "_fiberScale" + scale_str);
  sim.output_dir.path = path;
  model.setExtraFiberStiffness(
